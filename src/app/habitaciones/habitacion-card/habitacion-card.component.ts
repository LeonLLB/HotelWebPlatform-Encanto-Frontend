...
@Component({
  ...
  template: `
    <div 
      class="w-80 gap-2 border-2 p-2 rounded-lg grid grid-cols-[3rem_minmax(0,1fr)_3rem] shadow-lg"
      [ngClass]="{
      ...
      <div class=" col-span-1 flex flex-col justify-evenly items-center">
